            ...
            <div class="col-md-4 mr-auto">
                <div class="card card-signup text-center">
                    <div class="card-header ">
                        ...
                        <div class="social">
                            <h5 class="card-description mb-0">  {{ __('Register With') }}</h5>
                            @foreach (config('techbros.socialite.services') as $item => $color)
                            <a href="/redirect/{{$item}}">
                                <button type="button" {!!$color ? "style='background-color: {$color};'" : ''!!} class="btn btn-icon btn-round btn-{{$item}}" >
                    ...
                    <div class="card-body ">
                        <form method="POST" id="{{ getFormId() }}" action="{{ route('register') }}">
                            @csrf
                            <!--Begin input name -->
