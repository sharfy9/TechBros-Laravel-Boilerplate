        ...
        <div class="col-md-4 mr-auto">
          <div class="card card-signup text-center">
            <div class="card-header ">
              ...
              <div class="social">
                <button class="btn btn-icon btn-round btn-google" style="background-color: #dd4b39;">
            ...
            <div class="card-body ">
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group {{ $errors->has('phone') ? ' has-danger' : '' }}">
                  ...
                  <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Phone') }}" type="text" name="phone" value="{{ old('phone') }}" required>
                 </div>
                 @if ($errors->has('phone'))
                    <span class="invalid-feedback" style="display: block;" role="alert">
